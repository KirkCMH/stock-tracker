...
export function buildChartData(data: FinancialReport[], isFinancial: boolean): ChartDataResult {
...
export const useChartData = () => {
  ...
  const chartData = computed<ChartDataResult>(() => {
    const isFinancial = selectedStock.value?.industry_type === 'Financial'
    return buildChartData(reports.value ?? [], isFinancial)
  })
